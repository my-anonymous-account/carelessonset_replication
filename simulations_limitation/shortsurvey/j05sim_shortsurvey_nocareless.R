...
careless_start <- carelessness_start_fn(n = n, type = "early", num_items = num_items) # dead code here
...
for(r in seq_len(R)){
  ...
  data_posword <- recode(data, keys = data_ls$keys[data_drop$idx_kept], xmax = 5L, xmin = 1L)
...
# save
save(out_CP_LS_SC, out_CP_LS, out_CP_SC, alpha, mc_cores, reliability_mat, antonym_mat, num_dropped,
     file = paste0(dir_save, "/", suffix_type, "_num-traits-dropped=", num_dropped,  "_prop-crls=", 0.0, "_n=", n,  "_R=", R, ".Rdata"))
